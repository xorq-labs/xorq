...
# ---------------------------------------------------------------------------
# resolve_parquet_cache_path: unit tests for the standalone path function
# ---------------------------------------------------------------------------
...
def test_resolve_parquet_cache_path_explicit_base_path(tmp_path):
...
def test_resolve_parquet_cache_path_explicit_base_path_ignores_cache_dir(
    tmp_path, monkeypatch
):
    base = tmp_path / "explicit"
    other = tmp_path / "other"
    monkeypatch.setattr("xorq.caching.storage.get_xorq_cache_dir", lambda: other)
    result = resolve_parquet_cache_path("my_cache", "abc123", base_path=base)
...
# ---------------------------------------------------------------------------
# CacheKey sidecar structure and cache_keys_paths relocatability
# ---------------------------------------------------------------------------
