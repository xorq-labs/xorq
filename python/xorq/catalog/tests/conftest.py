...
def _get_pointer_store_dir(tmp_path_factory):
    if "store" not in _pointer_store_dirs:
        _pointer_store_dirs["store"] = tmp_path_factory.mktemp("content-store")
    return _pointer_store_dirs["store"]
