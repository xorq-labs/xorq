...
def test_int_cv_returns_cross_val_score(classification_data, classifier_pipeline):
...
def test_int_cv_correct_number_of_folds(classification_data, classifier_pipeline):
    for k in (3, 5):
        result = deferred_cross_val_score(
            classifier_pipeline,
            classification_data,
...
def test_int_cv_scores_are_finite(classification_data, classifier_pipeline):
...
def test_int_cv_classifier_scores_bounded(classification_data, classifier_pipeline):
...
def test_int_cv_regressor_default_scorer(regression_data, regressor_pipeline):
    scores = deferred_cross_val_score(
        regressor_pipeline,
        regression_data,
        features=FEATURES,
...
def test_int_cv_explicit_scorer(classification_data, classifier_pipeline):
    scores = deferred_cross_val_score(
        classifier_pipeline,
        classification_data,
        features=FEATURES,
...
def test_int_cv_mean_close_to_sklearn(classification_data, classifier_pipeline):
...
def test_int_cv_reproducible_with_seed(classification_data, classifier_pipeline):
...
def test_timeseries_split_matches_sklearn(classification_data, classifier_pipeline):
...
def test_regressor_kfold_matches_sklearn(regression_data, regressor_pipeline):
...
def test_fold_expr_sklearn_splitter_columns(
    classification_data, classifier_pipeline, cv, expected_folds
):
    result = deferred_cross_val_score(
        classifier_pipeline,
        classification_data,
...
def test_fold_expr_timeseries_split(classification_data, classifier_pipeline):
...
def test_rejects_non_pipeline(classification_data):
