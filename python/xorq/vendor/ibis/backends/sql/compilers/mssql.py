...
from xorq.vendor.ibis.backends.sql.datatypes import MSSQLType
from xorq.vendor.ibis.backends.sql.dialects import MSSQL
...
if TYPE_CHECKING:
    ...
    import xorq.vendor.ibis.expr.operations as ir
