...
from xorq.vendor.ibis.common.typing import DefaultTypeVars
from xorq.vendor.ibis.util import is_iterable
...
class Value(Node, Coercible, DefaultTypeVars, Generic[T, S]):
    ...
    def __coerce__(
        ...
        from xorq.vendor.ibis.expr.operations.generic import NULL, Literal
