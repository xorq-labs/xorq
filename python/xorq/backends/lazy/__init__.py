...
class LazyBackend:
    ...
    *args, **kwargs
    ...
    @property
    def __class__(self):
        """Report the wrapped backend's type so isinstance() checks pass."""
    ...
    def is_connected(self) -> bool:
        """``True`` once ``do_connect`` has been called on the wrapped backend."""
        return object.__getattribute__(self, "_connected")

    def _ensure_connected(self) -> None:
        """Call ``do_connect`` at most once, thread-safely."""
