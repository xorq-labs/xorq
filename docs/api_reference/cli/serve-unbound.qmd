...
- If neither `--to_unbind_hash` nor `--to_unbind_tag` is provided, the command attempts to infer the target based on graph analysis; providing one is recommended for determinism.
