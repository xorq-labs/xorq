...
Additionally, when data freshness is required, that's automatic cache invalidation on data changes it uses the last modified time of files both disk-based and remote
