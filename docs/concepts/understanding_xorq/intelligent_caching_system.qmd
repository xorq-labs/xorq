...
Additionally, Xorq uses the last modified time of files (both disk-based and remote) to provide automatic cache invalidation when data freshness is required.
