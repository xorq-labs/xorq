...
<!-- `ingest` is the name of a skill, not a verb choice: it has to match
     the SKILL.md it links to and what the user types. Scoped to the table
     rather than the whole section, and a comment between two rows breaks
     the table, so the two tables carrying the name are wrapped separately. -->
