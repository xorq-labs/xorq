...
```bash
xorq serve-unbound builds/7061dd65ff3c --host localhost --port 8001 --cache-dir penguins_example abc6e819a19e0f61283a506be692d517
...
- `abc6e819a19e0f61283a506be692d517`: The specific node hash to serve

### Finding the Node Hash

The node hash (like `abc6e819a19e0f61283a506be692d517`) identifies a specific
