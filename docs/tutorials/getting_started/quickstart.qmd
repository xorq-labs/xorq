...
```{.python filename="query_pipeline.py"}
...
Congratulations! You've successfully built and served your first Xorq ML pipeline. You initialized a project, built an expression, ran predictions, and served your pipeline as an endpoint.

Here are suggested next steps to continue your journey:

- **[Take the 10-minute tour](/tutorials/getting_started/10-minute-tour)** — Go deeper with Xorq's features. Explore lineage tracking, caching, and multi-engine execution in a guided walkthrough.

- **[Train an XGBoost model](/tutorials/getting_started/hn_training_xgb)** — Apply what you learned to a real ML workflow. Train and serve an XGBoost model using the same patterns from this quickstart.

- **[Understand deferred execution](/concepts/deferred-execution)** — Learn how Xorq builds computation graphs and optimizes execution. This is the core concept behind everything you just built.

- **[Join the community](https://discord.gg/8Kma9DhcJG)** — Get help, share your projects, and connect with other Xorq users on Discord.
