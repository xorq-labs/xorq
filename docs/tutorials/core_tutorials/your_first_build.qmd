...
Now you understand builds. Continue exploring:

- [Manage the compute catalog](/guides/platform_workflows/manage_compute_catalog.qmd) shows how to organize builds in the catalog
- [Build reproducible environments](/guides/platform_workflows/build_reproducible_environments.qmd) explains uv-build for hermetic environments
- [Set up CI/CD pipelines](/guides/platform_workflows/setup_cicd_pipelines.qmd) covers automated build and deployment workflows
