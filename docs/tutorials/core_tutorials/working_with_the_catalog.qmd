...
- [Switch backends](../../getting_started/switch_backends.qmd)—see what kinds of profiles Xorq supports.
- [Explore caching](../../getting_started/explore_caching.qmd)—keep the recovered query path fast for downstream users.
