---
title: 'Building and Running Expressions'
---
...
- **Reproducibility**: Define transformations once and run them consistently across different environments
- **Reusability**: Build complex data pipelines and reuse them in different contexts
- **Deployment simplification**: Compile expressions in development and execute them in production
- **Version control**: Store compiled expressions in version control systems for traceability
- **Performance optimization**: Pre-compile expressions to avoid repeated parsing and optimization
- **Decoupling**: Separate development environments from execution environments
...
<Warning>
  Currently, we do not support the building of expressions in-memory tables
</Warning>
