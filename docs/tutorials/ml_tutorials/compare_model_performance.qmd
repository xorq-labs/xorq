...
description: "Run scikit-learn operations directly on database data and compare multiple models to find the best classifier"
icon: "chart-line"
...
4. Score the model on test data. `score_expr()` executes immediately and returns the accuracy score.
