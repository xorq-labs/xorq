---
title: "Model Training and Evaluation with XGBoost in xorq"
description: "Part 3: Learn how to train XGBoost models, make predictions, and evaluate model performance using xorq's deferred pipelines"
---
