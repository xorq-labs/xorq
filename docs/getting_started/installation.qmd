---
title: 'Install Xorq'
description: "Set up Xorq in your environment with Python 3.10 or higher"
icon: "download"
headline: "Get Xorq running on your machine"
---
...
Verify your installation by running a simple query. This example loads the iris dataset and filters it.
...
- [Your first Xorq expression](your_first_expression.qmd) shows you how to execute a basic Xorq expression
- [Explore caching](explore_caching.qmd) teaches you about cache hits and misses, plus how invalidation works
- [Train your first model](../tutorials/ml_tutorials/train_your_first_model.qmd) walks you through training a basic classification model with Xorq
