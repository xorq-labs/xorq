...
- **Leakage prone**: Feature generation on historical data causes silent temporal leakage. Models train on information they shouldn't have access to at prediction time.
...
Xorq sits between your data sources and your ML applications. It's not a replacement for your data warehouse or your model serving infrastructure, it's the layer that connects them.
...
- [Quickstart](/getting_started/quickstart.qmd) to build your first pipeline in under five minutes
